package com.baker.gateway.etcd.core;
...
import com.baker.gateway.etcd.api.EtcdResponseNullPointerException;
import com.baker.gateway.etcd.api.HeartBeatLeaseTimeoutListener;
...
public class EtcdClientImpl implements EtcdClient {
	...
	private volatile ConcurrentHashMap<String, EtcdClientImpl.EtcdWatcher> etcdWatchers = new ConcurrentHashMap<>();
    ...
    /**
     * 添加一个监听操作
     * @see EtcdClient#addWatcherListener(java.lang.String, boolean, WatcherListener)
     */
    @Override
